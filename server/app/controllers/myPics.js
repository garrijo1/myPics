...
module.exports = function (app, config) {
    ...
    router.post('mypics/userId', function(req, res, next){
    ...
    router.put('mypics/userId', function (req, res, next){
    ...
    router.delete('mypics/userId', function (req, res, next){
